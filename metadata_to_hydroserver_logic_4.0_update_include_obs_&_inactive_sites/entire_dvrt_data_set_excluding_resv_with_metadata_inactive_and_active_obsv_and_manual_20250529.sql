...
WHERE 
    ...
    AND (
        [STATION_MASTER].[STATION_NAME] NOT LIKE '%Reservoir%' AND 
        [STATION_MASTER].[STATION_NAME] NOT LIKE '%Outflow%' AND
        [COLLECTION_STATIONS].[STATION_NAME] NOT LIKE '%Reservoir%' AND 
        [COLLECTION_STATIONS].[STATION_NAME] NOT LIKE '%Outflow%'
    )
